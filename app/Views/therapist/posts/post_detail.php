...
<div class="page-container">
    <header class="page-header">
        <h1>Detail Postingan Komunitas</h1>
        <div class="breadcrumbs">
            <a href="<?= site_url('therapist/komunitas') ?>">Komunitas Terapis</a> / Postingan
        </div>
    </header>
    ...
    <section class="card comments-section">
        ...
        <form action="<?= site_url('therapist/komunitas/comment/' . $post['id']) ?>" method="post" class="comment-form">
            <?= csrf_field() ?>
