...
<div class="editor-container">
    ...
    <div class="editor-card">
        <form id="article-form" action="<?= site_url('admin/articles/save') ?>" method="post" enctype="multipart/form-data">
            <?= csrf_field() ?>
            ...
            <div class="form-group">
                ...
                <select name="author_id" id="author_id" class="input-field" required>
                    ...
                    <?php foreach ($authors as $author) : ?>
                        <option value="<?= esc($author['id']) ?>" <?= old('author_id') == $author['id'] ? 'selected' : '' ?>><?= esc($author['first_name'] . ' ' . $author['last_name']) ?></option>
                    <?php endforeach; ?>
                </select>
            </div>
