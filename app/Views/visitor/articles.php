...
<?= $this->section('title') ?>
Artikel Kesehatan Mental - RuangSela
<?= $this->endSection() ?>
...
<!-- BAGIAN 1: HEADER HALAMAN ARTIKEL -->
                ...
                <?php foreach ($articles as $article): ?>
                    <article class="article-card">
                        ...
                        <div class="card-content">
                            ...
                            <a href="<?= site_url('artikel/detail/' . $article['id']) ?>" class="read-more-link">Baca Selengkapnya <i class="ri-arrow-right-line"></i></a>
                        </div>
                    </article>
                <?php endforeach; ?>
            <?php else: ?>
