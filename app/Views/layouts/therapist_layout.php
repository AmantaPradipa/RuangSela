...
<head>
    ...
    <title><?= $this->renderSection('title') ?> - RuangSela Terapis</title>
...
<body>
    <div class="therapist-layout">
        <?= $this->include('components/sidebars/therapist_sidebar') ?>
        <div class="main-container">
            <?= $this->include('components/headers/therapist_header') ?>
